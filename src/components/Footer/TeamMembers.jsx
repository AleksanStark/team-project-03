            ...
            >
                <SwiperSlide>
                    <div className={css['swiper-slide']}>
                        <img
                            src={AleksanVartapetyan}
                            alt="Aleksan Vartapetyan"
                        />
                        <div className={css['swiper-info-container']}>
                            Aleksan Vartapetyan
                            <div>
                                <p className={css['swiper-info-name']}>
                                    Team Leader
                                </p>
                ...
                <SwiperSlide>
                    <div className={css['swiper-slide']}>
                        <img
                            src={TetianaTymoshchenko}
                            alt="Tetiana Tymoshchenko"
                        />
                        <div className={css['swiper-info-container']}>
                            Tetiana Tymoshchenko
                            <div>
                                <p className={css['swiper-info-name']}>
                ...
                <SwiperSlide>
                    <div className={css['swiper-slide']}>
                        <img src={AndriyBilous} alt="Andrii Bilous" />
                        <div className={css['swiper-info-container']}>
                            Andrii Bilous
                            <div>
                                <p className={css['swiper-info-name']}>
                            ...
                            <div className={css['swiper-icon-container']}>
                                ...
                                <a
                                    href="https://www.linkedin.com/in/andriibilous-ca/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="github icon"
                                >
