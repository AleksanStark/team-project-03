...
import { updateDailyNorma, getUserData } from '../auth/operations';
    ...
    extraReducers: builder => {
        builder
            ...
            .addCase(getUserData.fulfilled, (state, action) => {
                ...
                state.dailyNorma = action.payload.data.dailyNorma;
            })
            ...
            .addCase(addWaterRecord.fulfilled, (state, action) => {
                state.dailyRecords.push(action.payload.data);
                state.isLoading = false;
                state.error = null;
            })
            ...
            .addCase(deleteWaterRecord.rejected, (state, action) => {
                state.isLoading = false;
                state.error =
                    action.payload || 'Error deleting the water record';
            })
            ...
            .addCase(updateWaterRecord.rejected, (state, action) => {
                state.isLoading = false;
                state.error =
                    action.payload || 'Error updating the water record';
            });
    },
});
